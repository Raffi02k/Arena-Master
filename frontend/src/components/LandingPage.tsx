...
const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted, onLogIn, onViewDemo, onShowInfo, t }) => {
  const features = [
    {
    ...
    <div className="min-h-screen bg-transparent text-white selection:bg-green-500/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-8">
            ...
            <button 
              ...
              className="px-4 sm:px-5 py-2 sm:py-2.5 bg-green-500 text-black text-xs sm:text-sm font-bold rounded-lg hover:bg-green-400 transition-all shadow-[0_0_20px_rgba(34,197,94,0.3)]"
            >
              {t('signUp')}
            </button>
          </div>
      ...
      <section className="pt-32 sm:pt-40 pb-16 sm:pb-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tight leading-[0.95] mb-6 sm:mb-8">
              Create tournaments <span className="text-green-500 drop-shadow-[0_0_30px_rgba(34,197,94,0.5)]">in seconds</span>
            </h1>
            <p className="text-base sm:text-xl text-zinc-400 leading-relaxed mb-8 sm:mb-12 max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4 sm:justify-start justify-center">
              <button 
                onClick={onGetStarted}
                className="px-6 sm:px-8 py-3 sm:py-4 bg-green-500 text-black text-base sm:text-lg font-black rounded-xl hover:bg-green-400 transition-all shadow-[0_0_30px_rgba(34,197,94,0.4)] flex items-center gap-2 group w-full sm:w-auto justify-center"
              >
                {t('getStartedFree')}
              ...
              <button 
                onClick={onViewDemo}
                className="px-6 sm:px-8 py-3 sm:py-4 bg-zinc-900 text-white text-base sm:text-lg font-bold rounded-xl border border-zinc-800 hover:bg-zinc-800 transition-all w-full sm:w-auto"
              >
                {t('viewDemo')}
              </button>
            </div>
      ...
      {/* Features Grid */}
      <section className="py-20 sm:py-32 px-4 sm:px-6 bg-zinc-950/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4">{t('everythingYouNeed')}</h2>
            <p className="text-zinc-400 text-base sm:text-lg">{t('powerfulFeatures')}</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="p-6 sm:p-8 bg-zinc-900/50 border border-zinc-800 rounded-3xl hover:border-green-500/50 transition-all group"
              >
      ...
      <section className="py-20 sm:py-32 px-4 sm:px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-20 items-center">
          <div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-8 sm:mb-12">Support for all formats</h2>
            <div className="space-y-4 sm:space-y-6">
              {[
                ...
                <div key={i} className="p-5 sm:p-6 bg-zinc-900/30 border border-zinc-900 rounded-2xl hover:bg-zinc-900/50 transition-all cursor-default">
      ...
      <section className="py-20 sm:py-32 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto bg-zinc-900 border border-zinc-800 rounded-[32px] sm:rounded-[40px] p-8 sm:p-12 md:p-24 text-center relative overflow-hidden">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-black mb-4 sm:mb-6">{t('readyToCreate')}</h2>
          <p className="text-base sm:text-xl text-zinc-400 mb-8 sm:mb-12">{t('joinThousands')}</p>
          <button 
            onClick={onGetStarted}
            className="px-8 sm:px-12 py-4 sm:py-5 bg-green-500 text-black text-base sm:text-xl font-black rounded-2xl hover:bg-green-400 transition-all shadow-[0_0_40px_rgba(34,197,94,0.4)] w-full sm:w-auto"
          >
            {t('createFreeAccount')}
          </button>
        </div>
