      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <input
            ...
            disabled={isBye}
            className={`w-12 h-10 sm:w-14 sm:h-12 text-center font-black text-base sm:text-lg bg-zinc-950 border border-zinc-800 rounded-2xl outline-none focus:ring-2 focus:ring-green-500 text-white transition-all ${isBye ? 'opacity-50 cursor-not-allowed' : ''}`}
          />
        </div>
