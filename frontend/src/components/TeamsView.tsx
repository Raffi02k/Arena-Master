  ...
  return (
    <div className="p-4 sm:p-8 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 sm:mb-12">
        <div>
          <h1 className="text-3xl sm:text-4xl font-black mb-2">Teams & Performance</h1>
        ...
        <AnimatePresence mode="popLayout">
          {filteredStats.map((stat, index) => (
            <motion.div
              ...
              key={stat.teamName}
              className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 sm:p-6 flex flex-col lg:flex-row lg:items-center justify-between gap-6 hover:border-zinc-700 transition-all"
            >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8 px-0 sm:px-6 sm:border-l border-zinc-800">
