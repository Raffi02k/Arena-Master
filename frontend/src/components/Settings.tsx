    ...
    <div className="max-w-4xl mx-auto py-12 px-8">
      ...
      <div className="space-y-6 pb-24">
        ...
        <section className="bg-zinc-900/50 border border-zinc-800 rounded-[32px] p-8">
          ...
          <div className="flex items-center justify-between p-6 bg-zinc-900 rounded-2xl border border-zinc-800 mb-4">
            <div>
              <div className="font-bold text-zinc-200">{t('reloadApp')}</div>
              <div className="text-sm text-zinc-500">{t('reloadAppDesc')}</div>
            </div>
            <button
              onClick={handleReloadApp}
              className="px-6 py-3 bg-zinc-800 hover:bg-zinc-700 text-zinc-100 font-bold rounded-xl transition-all"
            >
              {t('reloadApp')}
            </button>
          </div>
