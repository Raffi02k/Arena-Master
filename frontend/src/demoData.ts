import { Tournament, TournamentFormat, MatchStatus, SwissInitialPairing, SwissPairingSystem } from './types';
...
export const getDemoTournaments = (): Tournament[] => {
  ...
  const swissTournament: Tournament = {
    ...
    pointsConfig: { win: 3, draw: 1, loss: 0 },
    currentRound: 1,
    swissConfig: { rounds: 3, initialPairing: SwissInitialPairing.RANDOM, pairingSystem: SwissPairingSystem.DUTCH },
    matches: [
